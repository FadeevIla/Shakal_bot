...
placeholders = {
    ...
    "kogo": ["руку", "шлюху", "подругу", "друг друга"],
    "volk": ["волк", "пацан", "брат"],
    ...
    "life": ["жизнь", "судьба", "путь", "реальность"],
    "success": ["успех", "достижение", "победу", "фарт"],
    "power": ["силой", "мощью", "властью"],
...
templates = [
    ...
    "Лучше ебать {kogo}, чем друг друга"
]
